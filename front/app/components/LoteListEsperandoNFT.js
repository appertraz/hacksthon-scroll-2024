// front/app/components/LoteListEsperandoNFT.js
const LoteListEsperandoNFT = () => {
    const estado = 'esperando'; // Estado fijo para esta vista
  ...
  export default LoteListEsperandoNFT;
